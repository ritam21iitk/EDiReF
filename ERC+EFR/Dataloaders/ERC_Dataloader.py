...
our_training_path = "../Data/MELD_train_efr.csv"
our_testing_path = "../Data/MELD_val_efr.csv"
save_path = "../Pickles_Meld_EFR/"
...
for utt in tqdm.tqdm(idx2utt.values()):
    ...
    if pp_utt != "pad":
      embedding = emb_model.encode(pp_utt)
      # weight_matrix[utt2idx[pp_utt]] = sent2emb[pp_utt].cpu()
      weight_matrix[utt2idx[pp_utt]] = embedding
