...
from pickle_loader_masac_efr import load_efr
...
def train(model, train_data_loader, epochs):
    ...
    for epoch in tqdm.tqdm(range(epochs)):
        ...
        if f1_2_cls > max_f1_2:
            ...
            max_f1_2 = f1_2_cls
            torch.save(model.state_dict(), "./efr_Masac_{epc}_model_{f1}.pth".format(epc = epoch,f1=f1_2_cls))
...
model.load_state_dict(torch.load("efr_Masac/efr_Masac_32_model_0.36533084808946875.pth"))
