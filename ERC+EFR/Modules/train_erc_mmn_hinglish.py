...
from pickle_loader_hinglish import load_erc
...
def train(model, train_data_loader, epochs):
    ...
    for epoch in tqdm.tqdm(range(epochs)):
        ...
        if f1_1 > max_f1_1:
            print(f"Saving model at epoch {epoch} with f1-score"+str(f1_1))
            max_f1_1 = f1_1
            torch.save(model.state_dict(), "erc_mn_hinglish/erc_mmn_hinglish_{epc}_model_{f1}.pth".format(epc = epoch,f1=f1_1))
...
weights1 = np.array([1/9,1/75,1/21,1/56,1/36,1/100,1/48,1/43])
